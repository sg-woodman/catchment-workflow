...
source(here("workflow/R/stream/group_sites.R")) # unused directly (whole_domain grouping), but 01_build_group_manifest.R checks for it defensively
source(here("workflow/R/stream/delineate_sites.R")) # load_group_rasters() — used by delineate_engine_catchments()
